...
CF_NAMES=("CLOUDFLARE_TUNNEL_TOKEN","CLOUDFLARE_TUNNEL_ID","CLOUDFLARE_PUBLIC_HOSTNAME","CLOUDFLARE_ORIGIN_SERVICE","WS_PORT","WS_PATH");CF={name:env(name) for name in CF_NAMES};CF_CONFIGURED=any(CF.values());CF_ENABLED=all(CF.values())
